...
\newenvironment<>{varblock}[2][.9\textwidth]{%
  ...
  \title[ИТММ'21\qquad ЗАДАЧА MARL  ДЛЯ СЕТИ СВЕТОФОРОВ]{ИТММ'21\qquad ЗАДАЧА MARL  ДЛЯ СЕТИ СВЕТОФОРОВ}
\author[Тисленко~Т.\,И., Семенова~Д.\,В.]{\large Солдатенко~А.\,А., Семенова~Д.\,В.}
...
{\huge {ЗАДАЧА MARL  ДЛЯ СЕТИ СВЕТОФОРОВ
}}

\bigskip

{\Large Т.\,И.~Тисленко, Д.\,В.~Семенова}

{\large Сибирский федеральный университет}

timtisko@mail.ru, DVSemenova@sfu-kras.ru
\end{center}
...
\begin{frame}
    ...
    \begin{table}
      ...
      \begin{tabular}{||c||c|c|c|c|c|}\hline
        \textbf{Критерий}    & \textbf{UTCS-1}  & \textbf{SCOOT}    & \textbf{OPAC}   & \textbf{MARL}         \\ \hline
        город      & Вашингтон     & Лондон &   \specialcell{Арлингтон,\\ Тускон} & Торонто \\ \hline
        \specialcell{временной\\ период} &1970е&1995&1983,1989& 2010\\ \hline
        \specialcell{длительность \\фаз} & \multicolumn{2}{|c|}{фиксированная}  & \multicolumn{2}{|c|}{переменная}       \\ \hline
        оптимизация & офлайн  & \multicolumn{3}{|c|}{онлайн}       \\ \hline
        предсказание & нет  & \multicolumn{2}{|c|}{есть} &нет      \\ \hline
        устройство & \multicolumn{2}{|c|}{централизованная}  & \multicolumn{2}{|c|}{децентрализованная}      \\ \hline
        \specialcell{основные \\ ограничения}   & \specialcell{постоянный \\сбор данных} & \specialcell{сенсоры \\далеко} & \specialcell{только для\\  8 фаз}& <<ПРОКЛЯТИЕ РАЗМЕРНОСТИ>> \\ \hline
      \end{tabular}
     \end{table}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}\frametitle{Перспективы исследования}
\justifying
\begin{figure}[h!]
